 ...
 */
public class DatePickerQuestionSet extends DatePicker
{

    @FindBy(css = "input#policy_start_date") WebElement startDateInputBox;

    public DatePickerQuestionSet(WebDriver driver)
    {
        super(driver);
    }
