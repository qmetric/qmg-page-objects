 ...
 */
public class LegacyWebsitePaymentPage extends BasePageObject
{

    @FindBy(css = "input#nbx_cardholder_name")
    ...
    @FindBy(css = "input.validate-required-check.inline.checkbox")
    List<WebElement> directDebitAgreementCheckBoxList;
    ...
    public LegacyWebsitePaymentPage(WebDriver driver)
    {
        super(driver);
    }
    ...
    public void enterDefaultDirectDebitDetails()
    {
        enterAccountHolderName("Any Name");
        String accountNumber = generateAccountNumber();
        enterAccountNumber(generateAccountNumber());
    ...
    {
        pause(3000);
        waitForElementPresent(20, "input#cardNo");
    }
